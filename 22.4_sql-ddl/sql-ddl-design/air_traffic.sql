...
CREATE TABLE cities (id SERIAL PRIMARY KEY, name TEXT NOT NULL, country INTEGER REFERENCES countries(id));
...
INSERT INTO countries (name) VALUES ('United States'), ('Japan'), ('Unitd Kingdom'), ('Mexico'), ('France'), ('Morocco'), ('UAE'), ('China'), ('Brazil'), ('Chile');
INSERT INTO cities (name, country) VALUES ('Washington DC', 1), ('Seattle', 1), ('Tokyo', 2), ('London', 3), ('Los Angeles', 1), ('Las Vegas', 1),
('Mexico City', 4), ('Paris', 5), ('Casablanca', 6), ('Dubai', 7), ('Beijing', 8), ('New York', 1), ('Charlotte', 1), ('Cedar Rapids', 1), ('Chicago', 1),
('New Orelans', 1), ('Sao Paolo', 9), ('Santiago', 10);
...
VALUES
  ('Jennifer', 'Finch', '33B', '2018-04-08 09:00:00', '2018-04-08 12:00:00', 1, 2, 2),
