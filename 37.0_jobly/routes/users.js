 ...
 **/
 ...
 router.post("/:username/jobs/:job_id", ensureAdminOrSameUser, async function (req, res, next) {
   try {
     const app = await User.apply(res.locals.user.username, req.params.job_id);
